...
class HoldingRegister(Enum):
    ...
    # SPEED NUMBER FOR MO. IN THE 1ST TIME PERIOD, Temperature setpoint for Mo. in the 1st period
    HR_SETWEEK_MO_1ST_PERIOD_SPEED_TEMP = 126

    # HOURS OF THE END OF THE 1ST PERIOD ON MO, Minutes of the end of the 1st period on Mo
    HR_SETWEEK_MO_1ST_PERIOD_END_HOURS_MINUTES = 127

    # SPEED NUMBER FOR MO. IN THE 2ND TIME PERIOD, TEMPERATURE SETPOINT FOR MO. IN THE 2ND PERIOD
    HR_SETWEEK_MO_2ND_PERIOD_SPEED_TEMP = 128

    # HOURS OF THE END OF THE 2ND PERIOD ON MO, MINUTES OF THE END OF THE 2ND PERIOD ON MO.
    HR_SETWEEK_MO_2ND_PERIOD_END_HOURS_MINUTES = 129

    # SPEED NUMBER FOR MO. IN THE 3RD TIME PERIOD, TEMPERATURE SETPOINT FOR MO. IN THE 3RD PERIOD
    HR_SETWEEK_MO_3RD_PERIOD_SPEED_TEMP = 130

    # HOURS OF THE END OF THE 3RD PERIOD ON MO, MINUTES OF THE END OF THE 3RD PERIOD ON MO.
    HR_SETWEEK_MO_3RD_PERIOD_END_HOURS_MINUTES = 131

    # SPEED NUMBER FOR MO. IN THE 4TH TIME PERIOD, TEMPERATURE SETPOINT FOR MO. IN THE 4TH PERIOD
    HR_SETWEEK_MO_4TH_PERIOD_SPEED_TEMP = 132

    # TEMPERATURE SETPOINT FOR MO. IN THE 4TH PERIOD
    HR_SETWEEK_MO_4TH_PERIOD_TEMP_END = 132
