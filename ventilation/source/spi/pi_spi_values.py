from spi.spi_values import (GenericSPIBus, GenericSPIDevice, GenericSPIMaxSpeedHz,
                            GenericSPIMode, GenericSPIBitsPerWord)


class RaspberryPiSPIBus(GenericSPIBus):
    """
...
class RaspberryPiSPIDevice(GenericSPIDevice):
    """
...
class RaspberryPiSPIMaxSpeedHz(GenericSPIMaxSpeedHz):
    """
...
class RaspberryPiSPIMode(GenericSPIMode):
    """
...
class RaspberryPiSPIBitsPerWord(GenericSPIBitsPerWord):
    """
