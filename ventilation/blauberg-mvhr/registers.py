...
class HoldingRegister(Enum):
    ...
    HR_SETWEEK_MO_1ST_PERIOD_SPEED = 126

    # TEMPERATURE SETPOINT FOR MO. IN THE 1ST PERIOD
    HR_SETWEEK_MO_1ST_PERIOD_TEMP = 126

    # HOURS OF THE END OF THE 1ST PERIOD ON MO.
    HR_SETWEEK_MO_1ST_PERIOD_END_HOURS = 127

    # MINUTES OF THE END OF THE 1ST PERIOD ON MO.
    HR_SETWEEK_MO_1ST_PERIOD_END_MINUTES = 127
